...
<head>
	...
	<title>3rd Year Projects View</title>
...
<body>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       $sql = "SELECT GPNo,GroupNo,CourseCode,ProjectTitle,StartDate,EndDate,noOfStudents,EvolutionTime,Academic_year FROM 3rd_year_group_project WHERE EmployeeID = '{$_SESSION['EmployeeID']}' && Academic_year = '{$_SESSION['Academic_year']}' && is_deleted=0";
       ...
       if (mysqli_num_rows($result) > 0) {
         while($row = mysqli_fetch_assoc($result)) {
		   ...
		   echo "<td><a href='3rdYearGroupEdit.php?id=" . $row["GPNo"] . "'>Edit</a></td>"; 
		   echo "<td><a href='3rdYearGroupDelete.php?id=" . $row["GPNo"] . "' onclick=\"return confirm('Are you sure?');\">Delete</a></td>"; 
   ...
   <a href="3rdYearGroupAdd.php"><button type="button" class="btn btn-primary">Add New</button></a>
   <a href="pdf_3rd_year_project.php"><button type="button" class="btn btn-info">Download</button></a>
 </div>
